<x-portal-layout :showHero="true" heroTitle="ユーザーの新規登録" heroSubtitle="新しいユーザー情報をシステムに登録します。">
    ...
    <div class="bg-[var(--card-bg)] p-6 md:p-8 rounded-xl shadow-md max-w-2xl mx-auto">
        ...
        <form action="{{ route('admin.users.store') }}" method="POST" enctype="multipart/form-data"> {{-- ★enctypeを追加 --}}
            @csrf
            ...
            <div class="space-y-6">
                ...
                {{-- パスワード --}}
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700">パスワード <span
                            class="text-red-500">*</span></label>
                    <div class="mt-1">
                ...
                {{-- パスワード（確認用） --}}
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700">パスワード（確認用） <span
                            class="text-red-500">*</span></label>
                    <div class="mt-1">
