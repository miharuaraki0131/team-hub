                    ...
                    <div class="mt-12 p-6 bg-blue-50 rounded-xl border-2 border-blue-200">
                        ...
                        <div class="space-y-3 text-blue-700">
                            <div class="flex items-start">
                                <span
                                    class="flex-shrink-0 w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold mr-3">1</span>
                                <div>
                            ...
                            <div class="flex items-start">
                                <span
                                    class="flex-shrink-0 w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold mr-3">2</span>
                                <div>
                            ...
                            <div class="flex items-start">
                                <span
                                    class="flex-shrink-0 w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold mr-3">3</span>
                                <div>
                            ...
                            <div class="flex items-start">
                                <span
                                    class="flex-shrink-0 w-8 h-8 bg-blue-200 rounded-full flex items-center justify-center text-sm font-bold mr-3">4</span>
                                <div>
