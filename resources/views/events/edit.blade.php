        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
            ...
            <div class="p-8 bg-slate-100 border-b-2 border-gray-200">
                <div class="flex flex-col sm:flex-row justify-between items-start">
                    <div>
                        <h1 class="text-4xl font-bold text-gray-800 mb-2">✏️ 予定の編集</h1>
                        <p class="text-lg text-gray-600">既存の予定の内容を更新します</p>
                    </div>
            ...
            {{-- フォーム --}}
            <form method="POST" action="{{ route('events.update', $event) }}" class="flex flex-col">
                @csrf
                @method('PUT')
                ...
                <div class="p-8 md:p-12 flex-grow space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="date" name="start_date"
                                    value="{{ old('start_date', $event->start_datetime->format('Y-m-d')) }}"
                                ...
                                <input type="time" name="start_time"
                                    value="{{ old('start_time', $event->start_datetime->format('H:i')) }}"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-base focus:border-green-500 focus:ring-2 focus:ring-green-200">
                                @error('start_date')
                                    <div
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="date" name="end_date"
                                    value="{{ old('end_date', $event->end_datetime->format('Y-m-d')) }}"
                                ...
                                <input type="time" name="end_time"
                                    value="{{ old('end_time', $event->end_datetime->format('H:i')) }}"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg text-base focus:border-red-500 focus:ring-2 focus:ring-red-200">
                                @error('end_date')
                                    <div
                                        class="mt-1 p-2 bg-red-50 border border-red-300 rounded-lg text-red-700 text-sm font-medium">
                    ...
                    <div>
                        ...
                        <textarea id="body" name="body" rows="6"
                            ...
                            placeholder="ミーティングのアジェンダ、場所、ZoomのURLなど、補足情報を入力します">{{ old('body', $event->body) }}</textarea>
                    </div>
