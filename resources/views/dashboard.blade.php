                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
                                    @foreach ($latestKnowledges as $knowledge)
                                        <a href="{{ route('knowledges.show', $knowledge) }}"
                                            class="block bg-white rounded-xl border-2 border-gray-200 hover:border-blue-400 hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1 p-4 lg:p-6">

                                            {{-- カードヘッダー --}}
                                            <div class="flex items-start justify-between mb-3">
                                                <span class="font-bold text-base lg:text-lg text-gray-800 break-words">
                                                    {{ $knowledge->title }}
                                                </span>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                                    @foreach ($thisWeeksEvents->groupBy(function ($event) {
                                        ...
                                        <div class="flex flex-col">
                                            {{-- 日付ヘッダー --}}
                                            <div class="mb-2">
                                                <span class="font-bold text-base lg:text-lg text-gray-700 bg-gray-100 px-3 py-1 rounded-lg">
