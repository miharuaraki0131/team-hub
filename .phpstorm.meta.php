...
'profile.update','profile.destroy','weekly-reports.show','daily-reports.edit','daily-reports.storeOrUpdate',
'weekly-goals.edit','weekly-goals.storeOrUpdate','knowledges.index','knowledges.create','knowledges.store',
'knowledges.show','knowledges.edit','knowledges.update','knowledges.destroy','events.json',
'events.index','events.create','events.store','events.show','events.edit',
'events.update','events.destroy','projects.index','projects.create','projects.store',
'projects.show','projects.edit','projects.update','projects.destroy','tasks.index',
'tasks.ganttData','tasks.store','tasks.show','tasks.update','tasks.destroy',
'tasks.updatePositions','tasks.summary','notifications.index','notifications.count','notifications.markAsRead',
'admin.users.index','admin.users.create','admin.users.store','admin.users.show','admin.users.edit',
'admin.users.update','admin.users.destroy','admin.divisions.index','admin.divisions.create','admin.divisions.store',
'admin.divisions.show','admin.divisions.edit','admin.divisions.update','admin.divisions.destroy','register','login','password.request','password.email',
...
'admin.divisions.create','admin.divisions.edit','admin.divisions.index','admin.divisions.show','admin.users.create',
'admin.users.edit','admin.users.index','admin.users.show','auth.confirm-password','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','components.application-logo',
'components.auth-session-status','components.danger-button','components.dropdown','components.dropdown-link','components.flash-message',
'components.input-error','components.input-label','components.modal','components.nav-link','components.portal-layout',
'components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input','components.textarea-card',
'daily-reports.edit','dashboard','events.create','events.edit','events.index',
'events.show','knowledges.create','knowledges.edit','knowledges.index','knowledges.show',
'layouts.guest','layouts.portal-navigation','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','projects._task_list','projects.create','projects.index','projects.show',
'tasks.index','weekly-goals.edit','weekly-reports.show','welcome','laravel-exceptions-renderer::components.card',
